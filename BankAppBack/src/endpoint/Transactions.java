...
public class Transactions extends BaseEndpoint implements HttpHandler {
        ...
        if("GET".equals(httpExchange.getRequestMethod())) {
            ...
            try {         //РАБОЧИЙ КОД
                ...
                while (resultSet.next()) {
                    ...
                    transaction = new Transaction(resultSet.getInt(1),resultSet.getString(2),resultSet.getString(3),
                            String.valueOf(resultSet.getDate(4)),String.valueOf(resultSet.getTime(5)));
            ...
            requestParamValue = transactions.toString();
        }

...
public class TransactionsConroller extends BaseEndpointController implements HttpHandler {

    private TransactionalService transactionalService;

    public TransactionsConroller() {
    ...
    public void handle(HttpExchange httpExchange) throws IOException {
        ...
        if("GET".equals(httpExchange.getRequestMethod())) {
            ...
            List<String> transactions = transactionalService.findAll();
